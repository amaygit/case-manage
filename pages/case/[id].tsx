...
const CaseView = (props) => {
  const [mycase, setMyCase] = useState<CaseInterface>({
    ...
    complainentPin: "",
    complainentCity: "Banglore",
    complainentState: "Karnataka",
    complainentAddress: "Sector-V, Salt Lake, Banglore-700091, WB",
    respondentName: "",
    respondentEmail: "",
    respondentPhone: 0,
    ...
    respondentPin: "",
    respondentCity: "Banglore",
    respondentState: "Karnataka",
    respondentAddress: "sector-V, Salt Lake, Banglore-700091, WB",
    causeOfAction: "",
